...
export const Converter: React.FC<ConverterProps> = ({
    ...
    <Stack spacing={2}>
        ...
        <Typography variant="caption">
            When a variable has one of the following display formats applied, it
            will be converted as a numeric variable with a date/time/datetime
            value.
        </Typography>
        <Typography variant="caption">
            When adding a new format, do not use W.D part of the format. For
            example, to handle &quot;DATE9.&quot; or &quot;DATE11.&quot; formats
            use the &quot;DATE&quot; value.
        </Typography>
        <Autocomplete
            multiple
        ...
        />
        <Typography variant="caption">
            When a variable has one of the following suffixes applied, it will
            be converted as a numeric variable with a date/time/datetime value.
        </Typography>
        <Stack spacing={0}>
            <FormControlLabel
                control={
