...
import CompareDataContainer from '@components/Compare/CompareDataContainer';
...
import BottomToolbar from '@components/Compare/BottomToolbar';
import ApiService from '@services/ApiService';
import DifferencesModal from '@components/Compare/DifferencesModal';
    ...
    useEffect(() => {
        const loadData = async () => {
            ...
            try {
                ...
                // For filtered data we need to use pageMaps, as they correctly indicate where a page starts
                const pageMaps = datasetDiff?.pageMaps || {
                    base: [],
                    comp: [],
                };
                // Load base file
                ...
                const newBaseData = await getData(
                    apiService,
                    fileBaseInfo.fileId,
                    pageMaps.base[page] || page * pageSize,
                    pageSize,
                    settings,
                    commonCols,
                    currentFilter,
                ...
                const newCompData = await getData(
                    apiService,
                    fileCompInfo.fileId,
                    pageMaps.comp[page] || page * pageSize,
                    pageSize,
                    settings,
                    commonColsComp,
                    currentFilter,
